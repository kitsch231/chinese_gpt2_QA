...
def set_args():
    ...
    parser.add_argument('--temperature', default=0.8, type=float, required=False, help='生成的temperature')
    parser.add_argument('--topk', default=16, type=int, required=False, help='最高k选1')
    ...
    parser.add_argument('--model_path', default='model/epoch13', type=str, required=False, help='对话模型路径')
