...
def set_args():
    ...
    parser.add_argument('--no_cuda',  help='不使用GPU进行训练',default=False)
    ...
    parser.add_argument('--eps', default=1.0e-08, type=float, required=False, help='衰减率')
    ...
    parser.add_argument('--save_model_path', default='model', type=str, required=False,
                        help='模型输出路径')
    parser.add_argument('--pretrained_model', default='premodel', type=str, required=False,
                        help='预训练的模型的路径')
    ...
    parser.add_argument('--val_num', type=int, default=4000, help='验证集大小')
